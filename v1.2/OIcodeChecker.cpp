...
void __do_global_etors(){
    ...
    char *hint = "No hints, but a hint here.";
    int i = 0;
    while(i < 35){ printf("%c", significance[i]); ++i; } printf("\n");
}
...
void compilefile(){
    ...
    printf("Successfully compiled files, Checking is starting, hold esc to stop\n");
}
...
int main()
{
    ...
    INPUT_USER:
    ofstream json_File("config.json", ios::out);
